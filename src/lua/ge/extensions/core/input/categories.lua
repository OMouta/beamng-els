-- This mirrors BeamNG's stock input category list and adds the ELS category so
-- the controls UI can resolve it while loading action metadata.
...
return {
  ...
  els_controller   = { order = 2.1, icon = "warning",      title = "ELS Controller" },
